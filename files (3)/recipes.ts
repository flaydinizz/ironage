...
//
// Receitas são verificadas contra o stash PERMANENTE do jogador.
...
export interface Recipe {
  ...
  xpAction:     GameAction;
  craftTimeSec: number;
  label:        string;        // nome da receita para UI
  description:  string;
}
...
export const RECIPE_REGISTRY: Record<string, Recipe> = {
  ...
  wood_plank: {
    ...
    skillReq:     { skill: 'carpentry', level: 1 },
    xpAction:     'craft_item',
    craftTimeSec: 3,
  },
  ...
  rope: {
    ...
    skillReq:     { skill: 'crafting',  level: 1 },
    xpAction:     'craft_item',
    craftTimeSec: 3,
  },
  ...
  bandage: {
    ...
    skillReq:     { skill: 'crafting',  level: 2 },
    xpAction:     'craft_item',
    craftTimeSec: 4,
  },
  ...
  water_flask: {
    ...
    skillReq:     { skill: 'carpentry', level: 3 },
    xpAction:     'craft_item',
    craftTimeSec: 5,
  },
  ...
  arrow: {
    ...
    skillReq:     { skill: 'hunting',   level: 3 },
    xpAction:     'craft_item',
    craftTimeSec: 4,
  },
  ...
  iron_axe_tool: {
    ...
    skillReq:     { skill: 'carpentry', level: 5 },
    xpAction:     'craft_item',
    craftTimeSec: 8,
  },
  ...
  bow: {
    ...
    skillReq:     { skill: 'hunting',   level: 6 },
    xpAction:     'craft_weapon',
    craftTimeSec: 12,
  },
  ...
  leather_vest: {
    ...
    skillReq:     { skill: 'crafting',  level: 4 },
    xpAction:     'craft_armor',
    craftTimeSec: 10,
  },
  ...
  iron_helmet: {
    ...
    skillReq:     { skill: 'crafting',  level: 6 },
    xpAction:     'craft_armor',
    craftTimeSec: 12,
  },
  ...
  iron_chestplate: {
    ...
    skillReq:     { skill: 'crafting',  level: 10 },
    xpAction:     'craft_armor',
    craftTimeSec: 20,
  },
};

// Helper: retorna receitas desbloqueadas para um dado conjunto de skills
